#Faça um programa que leia um número inteiro qualquer e escreva a sua tabuada
#não fiz com estrutura de repetição pois até o presente momento não sei como usar em python
